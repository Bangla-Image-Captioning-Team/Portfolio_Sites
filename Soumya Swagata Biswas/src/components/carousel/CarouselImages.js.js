        ...
        <div className={classes.carousel_container} id="start">
            ...
            <Carousel className={classes.carousel} dynamicHeight infiniteLoop={true} interval={6000} useKeyboardArrows={true} transitionTime={1700} emulateTouch showArrows={false} autoPlay  showStatus={false} showThumbs={false} >
                <div  className={classes.image_container} >
                    <img className={classes.image} src={helloworld}  alt="myImage"/>
                    <div  className={classes.h1}>
                       <h1 >I'm Soumya ^-^</h1>
                       <a href="https://drive.google.com/file/d/1RD3-3EWUKT_EXeqzg2Z74Wkyne28jzqe/view?usp=sharing" rel="opener noreferrer" target="_blank">VIEW CV   <FaArrowCircleDown/></a>
                    </div>
                </div>
                <div className={classes.image_container}>
                    <img className={classes.image} src={Pencil} alt="myImage"/>
                    <div  className={classes.h2}> 
                    <h1> I love creating projects,though they don't all work... :v</h1>
                    <i class="em em-sweat" aria-role="presentation" aria-label="FACE WITH COLD SWEAT"></i>
                    <a href="https://github.com/LSK987" rel="opener noreferrer" target="_blank">VIEW PROJECTS   <GoProject/></a>
                    </div>
                </div>
                {/* <div className={classes.image_container}>
